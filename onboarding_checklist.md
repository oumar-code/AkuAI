# AkuAI Onboarding Checklist

Use this checklist to get started with AkuAI.
...
## 6. Build & Run
- [ ] Build Docker image: `docker build -t akuai:latest .`
- [ ] Run locally: `npm run dev` or `npm start`
- [ ] Or run with Docker: `docker run -p 8080:8080 akuai:latest`
